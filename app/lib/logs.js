...
lib.append = function(file, str, callback){
    ...
    fs.open(lib.baseDir + file + '.log', 'a', function(err, fileDescriptor){
        if (!err && fileDescriptor) {
            ...
            callback('Error: Could not open for appending');
        }
    });
}
                                ...
                                if (!err) {
                                    ...
                                    fs.close(fileDescriptor, function(err){
                                        if (!err) {
                                            ...
                                            callback('Error closing the destination file');
                                        }
                                    })
                                } else {
                                    callback(err)
...
// Decompress the content of the a .gz.b64 file into a string variable
